...
public SpeechletResponse onLaunch(SpeechletRequestEnvelope<LaunchRequest> requestEnvelope) {
    ...
    String speechOutput =
           "Welcome to Alexa UberSkill. You can ask me to book a uber cab";
...
public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
    ...
    if ("ubercustomslot".equals(intentName)) {
        return getHelloWorldIntent(intent);
    } else if ("AMAZON.HelpIntent".equals(intentName)) {
        return getHelp();
    } else if ("AMAZON.StopIntent".equals(intentName)) {
        PlainTextOutputSpeech outputSpeech = new PlainTextOutputSpeech();
        outputSpeech.setText("Uberskill closed");
...
private SpeechletResponse getHelloWorldIntent(Intent intent) {
	...
	Slot nameSlot=intent.getSlot("ubername");
    String value1=nameSlot.getValue();
    
    switch(value1){
    case "ubergo":
    	reString = "You are in ubergo swich case";
    	
    	 break;
    case "uberXL": 
    	reString= "You are in uberXL swich case";
  ...
  String  responseText = reString;
          ...
          card.setContent(responseText);
            ...
            repromptOutputSpeech.setText("customslot");
