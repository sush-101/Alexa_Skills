package com.custom.calcicustom;
...
public SpeechletResponse onLaunch(SpeechletRequestEnvelope<LaunchRequest> requestEnvelope) {
    ...
    String speechOutput =
           "Welcome to Alexa Calci Skill. You can ask me "
...
public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
    ...
    if ("calculationintent".equals(intentName)) {
        ...
        outputSpeech.setText("Hope I served you");

        return SpeechletResponse.newTellResponse(outputSpeech);
    } else if ("AMAZON.CancelIntent".equals(intentName)) {
        PlainTextOutputSpeech outputSpeech = new PlainTextOutputSpeech();
        outputSpeech.setText("I was nice helping you");
...
private SpeechletResponse getHelloWorldIntent(Intent intent) {
        ...
        Slot nameSlot=intent.getSlot("operation");
        String value=nameSlot.getValue();
        switch(value) {
        case "addition" : 
        	return getAddIntent(intent);
        case "subtraction" :
...
private SpeechletResponse getAddIntent(Intent intent) {
